...
image_id = input("\nGive the aws image id which you want to set your instance with (default it will take 'ami-0a9c4d7a9c3036856'): ")
...
if image_id=='':
    image_id = 'ami-0a9c4d7a9c3036856'
else:
    pass
...
instances = ec2.create_instances(
     ...
     KeyName=keyname,
     EbsOptimized= True,
     NetworkInterfaces= [ { 'AssociatePublicIpAddress': False,'DeviceIndex': 0,'SubnetId':'subnet-0089af512f35c19d1',
                          'Groups':['sg-09186a49da403fe97']}],
